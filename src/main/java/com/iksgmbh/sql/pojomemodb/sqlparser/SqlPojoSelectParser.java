...
import static com.iksgmbh.sql.pojomemodb.utils.StringParseUtil.parseNextValueByLastOccorrence;
...
public class SqlPojoSelectParser extends AbstractSqlPojoMemoryParser
{
	...
	public ParsedSelectData parseSelectSql(final String sql) throws SQLException 
	{
		...
		parseResult = parseNextValueByLastOccorrence(parseResult.unparsedRest, FROM);
